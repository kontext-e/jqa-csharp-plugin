...
public class CSharpToJsonToolFolders {
    ...
    public String buildToolPath() {
        ...
        return appDirs.getUserDataDir("csharp-to-json-converter", "0.2.0", "jqassistant-contrib");
    }

    public String buildPluginDataPath() {

        return appDirs.getUserDataDir("csharp-jqassistant-plugin", "0.2.0", "jqassistant-contrib");
    }
}
